function Convert()
            {
                ...
                {   val=Math.round(val);
                    ...
                    else if(units_from=="kelvin" && units_to=="farenheit")
                    {
                        var f = (val - 273.15) * (9/5) + 32;
                        result.textContent=f+' °'+'Farhenheit';

                    }
                    else if(units_from=="celsius" && units_to=="farenheit")
                    { 
                        var f=(9/5)*val+32;
                        result.textContent=f+' °'+'Farhenheit';
                    }
                    ...
                    else if(units_from=="farenheit" && units_to=="celsius")
                    { 
                        var c=((val-32)*5)/9;
                        result.textContent=c+'°'+'Celsius';
                    }
                    else if(units_from=="farenheit" && units_to=="kelvin")
                    { 
